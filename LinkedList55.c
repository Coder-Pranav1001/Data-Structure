/*
	Description :- Data Structure Application
...
{	
	...
	printf("Welcome to the data structure application written by Pranav Sonawane\n");
	
	while(1) // Unconditional loop. the loop without any condition
	{
		printf("---------------------------------------------\n");
